    ...
    return (
        <div>
            <div className="mb-6 space-y-1">
                <h2 className="text-xl font-bold font-serif uppercase tracking-wide text-[#0f172a]">Navigation Menu Builder</h2>
                <p className="text-[13px] text-[#64748b]">Manage header and footer navigation links.</p>
            </div>
