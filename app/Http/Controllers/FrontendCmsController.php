...
class FrontendCmsController extends Controller
{
    public function index()
    {
        ...
        $items = \App\Models\MenuItem::with(['children', 'parent'])->orderBy('sort_order', 'asc')->get();
        $parentItems = \App\Models\MenuItem::whereNull('parent_id')->orderBy('sort_order', 'asc')->get();
